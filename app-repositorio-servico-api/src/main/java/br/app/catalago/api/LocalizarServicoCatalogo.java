...
public class LocalizarServicoCatalogo<IServicoCatalago> extends AbstractLocalizadorServico<IServicoCatalago> {
	...
	public LocalizarServicoCatalogo(TipoLocalizador tipoLocalizacao) {
		super(tipoLocalizacao, REGISTRO_NOME_REMOTO, REGISTRO_NOME_LOCAL, LOCALIZACAO_SERVICO);
	}

	public LocalizarServicoCatalogo() {
